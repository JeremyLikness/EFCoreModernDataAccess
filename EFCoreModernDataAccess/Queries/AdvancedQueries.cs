        ...
        private static async Task WhichAttendeesShareTheMostOrLeastSessionsAsync(ConferenceContext context)
        {
            ...
            var answers =
                context.Attendees
                 ...
                 .GroupBy(a => new
                 {
                     a.a1Id, a.a1FirstName, a.a1LastName, a.a2Id, a.a2FirstName, a.a2LastName
                 })
                 .Select(g => new
                 {
                     g.Key.a1Id, g.Key.a1FirstName, g.Key.a1LastName, g.Key.a2Id, g.Key.a2FirstName, g.Key.a2LastName,
                     count = g.Count()
                 });
